...
namespace X.DnsClient.Security
{
    ...
    public class ApiKeyAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var claims = new[] {
                new Claim(ClaimTypes.NameIdentifier, "x-dns-api"),
                new Claim(ClaimTypes.Name, "x-dns-api-v1"),
            };
            ...
            Request.Headers.TryGetValue("x-api-key", out var extractedApiKey);
            Security.Rollbar.LogInfo("API: " + extractedApiKey);
